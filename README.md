...
| 이름 | 이메일 |역할 |
| ------ | -- | ----------- |
| 권준영 | @ | 프로젝트 총괄, DB 설계, 회원제 기능, 상품 요청 , 회원비밀번호 암호, 로그인 |
| 남윤재 | @ | 상품 주문, 장바구니,체크박스 사용 다중 구매/삭제 , 결제 API, 상품 이용 후기|
| 송혜리 | @ | UI/UX, 회원가입 기능(유효성검사,중복검사 ajax), 카카오 주소api ,지도api, 검색기능 |
| 오석진 | @ | DB 설계, 상품정보 및 주문정보(관리자페이지), 파일 업로드, 페이징 기능 |
| 이지현 | @ | UI/UX, 회원정보(관리자 페이지), 마이 페이지, 검색 기능, 상품후기,페이징 기능 |
### 백엔드 및 프론트엔드
...
![ERD](https://github.com/5seokjin/Sooldansok/assets/131237772/0f288958-7ed6-4876-987c-9a5e2545881a)
